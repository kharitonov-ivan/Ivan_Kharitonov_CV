...
\begin{tabular}{@{}L!{\VRule}R}
    ...
    \end{itemize}
    I organize weekly research papers reading seminars. Several ideas from these seminars found themselves in the production models.
    ...
    \end{itemize}
    Using: \mymk{MATLAB}, \mymk{Simulink}, \mymk{Vector CANAPE}                                                                                                \\  
\end{tabular}                                                                                                \\
    %
\begin{tabular}{@{}L!{\VRule}R} 
    % FORMULA STUDENT
